...
Public Class 指甲油
    ...
    Private Sub 指甲油_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click '新增購物車紀錄
        ...
        購物車.Label37.Text = Val(購物車.Label37.Text) + Val(TextBox3.Text)
        購物車.Label36.Text = Val(購物車.Label36.Text) + Val(TextBox2.Text)
        購物車.Label35.Text = Val(購物車.Label35.Text) + Val(TextBox4.Text)
        購物車.Label34.Text = Val(購物車.Label34.Text) + Val(TextBox5.Text)
        ...
        購物車.Label32.Text = 380 * TextBox2.Text
        購物車.Label33.Text = 380 * TextBox3.Text
        購物車.Label31.Text = 380 * TextBox4.Text
        購物車.Label30.Text = 290 * TextBox5.Text
