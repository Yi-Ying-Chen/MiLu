...
Public Class 便籤夾
    ...
    Private Sub 便籤夾_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click
        ...
        購物車.Label44.Text = Val(購物車.Label44.Text) + Val(TextBox3.Text)
        ...
        購物車.Label43.Text = 85 * TextBox3.Text
